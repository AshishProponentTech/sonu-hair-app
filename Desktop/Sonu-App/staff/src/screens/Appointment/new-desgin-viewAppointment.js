            ...
            >
              <Pressable key={"idx"} onPress={() => setSelectedStaff({})}>
                <LinearGradient
                  colors={
                    !selectedStaff.id
                      ? ["#ffffffd2", "#f7ddae", "#fff6e4d9"] // Selected colors (more golden)
                      : ["#fff", "#fff"] // Default colors
                  }
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 1 }}
                  style={{
                    borderColor: !selectedStaff.id ? "#D2AE6A" : "#f3d9a7",
                    borderWidth: 1,
                    flex: 1,
                    marginHorizontal: 5,
                    borderRadius: 3,
                ...
                >
                  <View style={styles.singleStaffWrapper}>
                    <Image
                      style={{
                        ...styles.staffImage,
                        borderColor: selectedStaff.id ? "#D2AE6A" : "#fff",
                      }}
                      source={{
                ...
                >
                  <LinearGradient
                    ...
                    style={{
                      borderColor:
                        selectedStaff.id === data.id
                          ? "#D2AE6A" // Selected border color
                          : "#f3d9a7", // Default border color
                      borderWidth: 1,
                      flex: 1,
                      marginHorizontal: 5,
                      borderRadius: 3,
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={styles.singleAgenda}>
                          ...
                          <View style={{ paddingLeft: 20, flex: 1 }}>
                            {/* Service Name with Call Button (absolute positioned) */}
                            <View
                              style={{ position: "relative", paddingRight: 30 }}
                            >
                              <Text
...
const styles = StyleSheet.create({
  ...
  statusText: {
    fontSize: 16,
    fontWeight: "600", // Optional: for emphasis
    textAlign: "center",
  },
});
